...
class UIText { // eslint-disable-line no-unused-vars
    ...
    static Common = {
        ...
        keepRetrying: chrome.i18n.getMessage("__MSG_button_error_Keep_Retrying__"),
    ...
    static Warning = {
        ...
        warning403AutoRetryToast: (hostname, seconds) => chrome.i18n.getMessage("warning403AutoRetryToast", [hostname, seconds]),
        warning403AutoIncreaseDelayToast: (hostname, delayMs, seconds) => chrome.i18n.getMessage("warning403AutoIncreaseDelayToast", [hostname, delayMs, seconds]),
        warning403StalledRetry: (hostname) => chrome.i18n.getMessage("warning403StalledRetry", [hostname]),
        ...
        warningWebnovelParagraphImagesHint: chrome.i18n.getMessage("warningWebnovelParagraphImagesHint"),
        warningWebnovelParagraphImagesRateLimit: chrome.i18n.getMessage("warningWebnovelParagraphImagesRateLimit")
    };
